import pickle, IPython, os, math, sys, getopt, keras
import numpy as np
# import mkl
# mkl.get_max_threads()
# import faiss
...
def main():
    ...
    for environment_index in range(189, 190):
        if not os.path.exists('/mnt/big_narstie_data/chenxi/data/dataset_225/transitions_dict_' + str(environment_type) + '_' + str(environment_index)):
            print('not exist ' + str(environment_type) + '_' + str(environment_index))
            continue
