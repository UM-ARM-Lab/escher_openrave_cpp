...
def main():
    model = Model()
    filename = 'depth_and_boundary_combined_B_5_weighted_0.002_checkpoint/epoch=22.checkpoint.pth.tar'
    ...
    traced_script_module.save('depth_and_boundary_combined_B_5_weighted_0.002_checkpoint.pt')
