...
def main():
    ...
    with open('/mnt/big_narstie_data/chenxi/data/ground_truth_p1p2/data_model_3', 'r') as file:
        ground_truth_dict = pickle.load(file)

    with open('/mnt/big_narstie_data/chenxi/data/ground_truth_p1p2/partition_model_3', 'r') as file:
