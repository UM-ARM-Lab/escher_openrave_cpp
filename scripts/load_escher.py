...
def escher(env, active_dof_mode='whole_body', urdf_name=None):
    ...
    escher.GazeboOriginalDOFValues = np.array([ 0.00000000e+00,   1.30580638e-02,  -1.40269059e-03,
    ...
    escher.robot.SetDOFValues(escher.GazeboOriginalDOFValues)
